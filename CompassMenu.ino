void CompassMenu(void) {
  ...
  compass_var.heading = compass_var.headingOld * compass_var.p1 + compass_var.heading * compass_var.p2;
  ...
  /* NEWS Indicator */
  if ((int(compass_var.heading) == 0) || (int(compass_var.heading) == 90) || (int(compass_var.heading) == 180) || (int(compass_var.heading) == 270))
