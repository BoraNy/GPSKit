void AltitudeMenu(void) {
  ...
  if ((altitude_graph.y_altitude > 0) && (altitude_graph.y_altitude <= 100))
    altitude_graph.y_altitude = 64 - map(altitude_graph.y_altitude, 0, 100, 0, 44);

  if ((altitude_graph.y_altitude > 100) && (altitude_graph.y_altitude <= 500))
    altitude_graph.y_altitude = 64 - map(altitude_graph.y_altitude, 0, 500, 0, 44);

  if ((altitude_graph.y_altitude > 500) && (altitude_graph.y_altitude <= 1000))
    altitude_graph.y_altitude = 64 - map(altitude_graph.y_altitude, 0, 1000, 0, 44);

  if ((altitude_graph.y_altitude > 1000) && (altitude_graph.y_altitude <= 5000))
    altitude_graph.y_altitude = 64 - map(altitude_graph.y_altitude, 0, 5000, 0, 44);

  if ((altitude_graph.y_altitude > 5000) && (altitude_graph.y_altitude <= 10000))
    altitude_graph.y_altitude = 64 - map(altitude_graph.y_altitude, 0, 10000, 0, 44);
